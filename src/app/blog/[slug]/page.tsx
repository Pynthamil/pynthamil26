          ...
          {slug === "git-commit-go" && (
            <div className="space-y-7 text-[15px] sm:text-[15.5px] text-[#232564] dark:text-[#F5F5FF] leading-[1.75] font-sans pt-1">
              ...
              <div className="space-y-4">
                ...
                <p className="font-mono text-[13px] sm:text-[13.5px] text-[#11408F] dark:text-[#AEF0FF]">You start wondering:</p>
                <p className="italic text-[#232564] dark:text-[#F5F5FF] pl-2.5 border-l-2 border-[#11408F]/40 dark:border-[#AEF0FF]/40">
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF] pt-1">It lets you:</p>
                ...
                <p className="font-mono text-[13px] sm:text-[13.5px] text-[#11408F] dark:text-[#AEF0FF] pt-1">
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">
                  Instead of clicking buttons on GitHub’s website, you can send requests like:
                </p>
                <ul className="space-y-2 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-xs sm:text-[12.5px] bg-white dark:bg-[#13151E] px-2 py-0.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-semibold text-[#11408F] dark:text-[#AEF0FF]">GET</span>
                    <span>&rarr; retrieve data</span>
                  </li>
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-xs sm:text-[12.5px] bg-white dark:bg-[#13151E] px-2 py-0.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-semibold text-[#11408F] dark:text-[#AEF0FF]">POST</span>
                    <span>&rarr; create data</span>
                  </li>
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-xs sm:text-[12.5px] bg-white dark:bg-[#13151E] px-2 py-0.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-semibold text-[#11408F] dark:text-[#AEF0FF]">PATCH</span>
                    <span>&rarr; update data</span>
                  </li>
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-xs sm:text-[12.5px] bg-white dark:bg-[#13151E] px-2 py-0.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-semibold text-[#11408F] dark:text-[#AEF0FF]">DELETE</span>
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <div className="bg-white dark:bg-[#13151E] px-3.5 py-2.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[13px] sm:text-[13.5px] text-[#232564] dark:text-[#F5F5FF] break-all">
                  https://api.github.com/user/repos
                </div>
                <p>
                  This endpoint allows you to retrieve repositories connected to your account.
                </p>
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF] pt-1">Each endpoint defines:</p>
                <ul className="space-y-1.5 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none">+</span>
                ...
                <div className="pt-2">
                  <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF] mb-1">Documentation:</p>
                  <a
                    href="https://docs.github.com/en/rest/repos/repos"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#6666FF] dark:text-[#9999FF] hover:underline underline-offset-4 decoration-wavy decoration-[#6666FF] dark:decoration-[#9999FF] font-mono text-[12.5px] sm:text-[13px] break-all font-medium"
                  >
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">Steps:</p>
                <ul className="space-y-2 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none font-semibold">1.</span>
                    <span>Go to GitHub Settings</span>
                  </li>
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none font-semibold">2.</span>
                    <span>Scroll to Developer Settings</span>
                  </li>
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none font-semibold">3.</span>
                    <span>Select Personal Access Tokens</span>
                  </li>
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none font-semibold">4.</span>
                    <span>Generate new token</span>
                  </li>
                </ul>
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF] pt-1">Choose:</p>
                <ul className="space-y-1.5 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none">+</span>
                ...
                <div className="bg-white dark:bg-[#13151E] p-3.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[12.5px] sm:text-[13px] text-[#232564] dark:text-[#F5F5FF] space-y-1.5 mt-2">
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">Example GET request:</p>
                <div className="bg-white dark:bg-[#13151E] px-3.5 py-2.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[13px] sm:text-[13.5px] text-[#232564] dark:text-[#F5F5FF] break-all">
                  https://api.github.com/user/repos
                </div>
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">Add Authorization header:</p>
                <div className="bg-white dark:bg-[#13151E] px-3.5 py-2.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[13px] sm:text-[13.5px] text-[#232564] dark:text-[#F5F5FF] break-all">
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">POST request:</p>
                <div className="bg-white dark:bg-[#13151E] p-3.5 sm:p-4 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[12.5px] sm:text-[13px] text-[#232564] dark:text-[#F5F5FF] space-y-1 overflow-x-auto leading-relaxed">
                ...
                <ul className="space-y-1 pl-1 text-[12.5px] sm:text-[13px] font-mono text-[#11408F] dark:text-[#AEF0FF]">
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <div className="pt-2 font-mono text-[13px] sm:text-[13.5px] text-[#11408F] dark:text-[#AEF0FF]">
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">Focus on understanding:</p>
                <ul className="space-y-2 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none">+</span>
                    <span>request</span>
          ...
          {slug === "art-of-committing" && (
            <div className="space-y-7 text-[15px] sm:text-[15.5px] text-[#232564] dark:text-[#F5F5FF] leading-[1.75] font-sans pt-1">
              ...
              <div className="space-y-4">
                ...
                <p>
                  You see words like <span className="font-mono text-xs sm:text-[12.5px] bg-white dark:bg-[#13151E] px-2 py-0.5 border border-neutral-200/70 dark:border-[#9999FF]/30 text-[#11408F] dark:text-[#AEF0FF]">commit</span>,{" "}
                  <span className="font-mono text-xs sm:text-[12.5px] bg-white dark:bg-[#13151E] px-2 py-0.5 border border-neutral-200/70 dark:border-[#9999FF]/30 text-[#11408F] dark:text-[#AEF0FF]">branch</span>,{" "}
                  <span className="font-mono text-xs sm:text-[12.5px] bg-white dark:bg-[#13151E] px-2 py-0.5 border border-neutral-200/70 dark:border-[#9999FF]/30 text-[#11408F] dark:text-[#AEF0FF]">merge</span>,{" "}
                  <span className="font-mono text-xs sm:text-[12.5px] bg-white dark:bg-[#13151E] px-2 py-0.5 border border-neutral-200/70 dark:border-[#9999FF]/30 text-[#11408F] dark:text-[#AEF0FF]">rebase</span>… and suddenly you&apos;re scared to even touch the keyboard.
                </p>
                <p>
                ...
                <p className="font-mono text-[13px] sm:text-[13.5px] text-[#11408F] dark:text-[#AEF0FF] font-medium pt-1">
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">Think of it like:</p>
                <ul className="space-y-2 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none">+</span>
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF] pt-1">Each commit captures:</p>
                <ul className="space-y-1.5 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none">+</span>
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <p className="font-mono text-[13px] sm:text-[13.5px] text-[#11408F] dark:text-[#AEF0FF]">Simple, but powerful.</p>
              </div>
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <div className="font-mono text-[13px] sm:text-[13.5px] text-[#11408F] dark:text-[#AEF0FF] py-1">
                  Project Repository &rarr; Git Repository
                </div>
                <div className="bg-white dark:bg-[#13151E] px-3.5 py-2.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[13px] sm:text-[13.5px] text-[#232564] dark:text-[#F5F5FF]">
                  git init
                </div>
              </div>
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <div className="bg-white dark:bg-[#13151E] p-3.5 sm:p-4 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[13px] sm:text-[13.5px] text-[#232564] dark:text-[#F5F5FF] space-y-1.5">
                  <div>git add .</div>
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">Examples:</p>
                <div className="bg-white dark:bg-[#13151E] p-3.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[12.5px] sm:text-[13px] space-y-1.5 text-[#232564] dark:text-[#F5F5FF]">
                  <div>feat: add profile picture upload</div>
                  <div>fix: correct typo in navbar</div>
                  <div>chore: update dependencies</div>
                </div>
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF] pt-1">Quick guide:</p>
                <ul className="space-y-2 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none font-semibold">feat</span>
                    <span>&rarr; adding a new feature or functionality</span>
                  </li>
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none font-semibold">fix</span>
                    <span>&rarr; correcting something that was broken</span>
                  </li>
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none font-semibold">chore</span>
                    <span>&rarr; changes that don&apos;t affect the app behaviour directly (configs, dependencies, build tasks)</span>
                  </li>
                </ul>
                <div className="bg-white dark:bg-[#13151E] px-3.5 py-2.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-[13px] sm:text-[13.5px] text-[#232564] dark:text-[#F5F5FF] mt-2">
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3.5">
                ...
                <div className="font-mono text-[13px] sm:text-[13.5px] text-[#11408F] dark:text-[#AEF0FF] py-0.5">
                  GitHub &rarr; click the + icon &rarr; New repository
                </div>
                <p className="text-[13px] sm:text-[13.5px] font-mono text-[#11408F] dark:text-[#AEF0FF]">Choose:</p>
                <ul className="space-y-1.5 pl-1 text-[14.5px] sm:text-[15px]">
                  <li className="flex items-start space-x-2.5">
                    <span className="font-mono text-sm text-[#11408F] dark:text-[#AEF0FF] select-none">+</span>
              ...
              <div className="pt-5 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-4">
                <h2 className="text-[17px] sm:text-[18px] font-semibold text-[#232564] dark:text-[#F5F5FF]">
                  Helpful learning resources
                </h2>

                <div className="space-y-2.5">
                  <h3 className="font-mono text-[12.5px] sm:text-[13px] uppercase tracking-wider text-[#11408F] dark:text-[#AEF0FF] font-semibold">
                    Articles / Blogs
                  </h3>
                  <ul className="space-y-2 text-[14px] sm:text-[14.5px]">
                    <li>
                      <a
