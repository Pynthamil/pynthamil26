      ...
      <main className="w-full relative z-10 flex flex-col max-w-[490px] animate-in fade-in duration-200">
        ...
        <header className="flex items-center justify-between w-full mb-8">
          <Link
            href="/blog"
            onClick={() => playTone(880)}
            className="font-mono text-[14.5px] sm:text-[15px] tracking-tight text-[#232564] dark:text-[#F5F5FF] hover:text-[#6666FF] dark:hover:text-[#9999FF] transition-colors flex items-center space-x-1.5 focus:outline-none font-medium cursor-pointer"
          >
            <span>&larr;</span>
            <span>blog</span>
          </Link>
        ...
        <article className="space-y-6">
          ...
          {/* =========================================================
             ...
             ========================================================= */}
          {slug === "git-commit-go" && (
            <div className="space-y-6 text-[14px] sm:text-[14.5px] text-[#232564] dark:text-[#F5F5FF] leading-relaxed font-sans pt-1">
              {/* Intro */}
              ...
              <div className="pt-4 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3">
              ...
              <div className="pt-4 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3">
                ...
                <div className="pt-2">
                  ...
                  <a
                    ...
                    className="text-[#6666FF] dark:text-[#9999FF] hover:underline underline-offset-4 decoration-wavy decoration-[#6666FF] dark:decoration-[#9999FF] font-mono text-xs break-all font-medium"
                  >
            ...
            <div className="space-y-6 text-[14px] sm:text-[14.5px] text-[#232564] dark:text-[#F5F5FF] leading-relaxed font-sans pt-1">
              ...
              <div className="pt-4 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3">
                ...
                <div className="bg-white dark:bg-[#13151E] p-3.5 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-xs sm:text-[12.5px] text-[#232564] dark:text-[#F5F5FF] space-y-1">
                  <div>git add .</div>
                  <div className="text-[#232564]/50 dark:text-[#F5F5FF]/50 text-[11px] pt-1">// or specific files</div>
              ...
              <div className="pt-4 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-3">
                ...
                <div className="bg-white dark:bg-[#13151E] px-3.5 py-2 border border-neutral-200/80 dark:border-[#9999FF]/30 font-mono text-xs sm:text-[12.5px] text-[#232564] dark:text-[#F5F5FF] mt-2">
              ...
              <div className="pt-4 border-t border-neutral-200/70 dark:border-[#9999FF]/20 space-y-4">
                <h2 className="text-[16px] font-medium text-[#232564] dark:text-[#F5F5FF]">
                  Helpful learning resources
                </h2>
        ...
        <div className="pt-10 pb-6 border-b border-neutral-200/70 dark:border-[#9999FF]/20">
          <Link
            href="/blog"
            onClick={() => playTone(880)}
            className="font-mono text-xs text-[#6666FF] dark:text-[#9999FF] hover:underline underline-offset-4 font-medium flex items-center space-x-1 cursor-pointer"
          >
