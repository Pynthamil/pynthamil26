...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className="min-h-screen bg-neutral-100 dark:bg-neutral-900 text-[#111111] dark:text-[#F2F2F2] antialiased selection:bg-neutral-200 dark:selection:bg-neutral-800 selection:text-neutral-900 dark:selection:text-white">
        {children}
      </body>
    </html>
  );
