                  ...
                  {portfolioData.projects.map((project: Project, idx: number) => {
                    ...
                    return (
                      ...
                      >
                        {project.banner && (
                          <div 
                            className={`w-full sm:-mx-6 sm:w-[calc(100%+3rem)] md:-mx-10 md:w-[calc(100%+5rem)] lg:-mx-16 lg:w-[calc(100%+8rem)] mb-3 overflow-hidden rounded-xl flex items-center justify-center relative ${project.coverBg ? aspectClass : ''}`}
